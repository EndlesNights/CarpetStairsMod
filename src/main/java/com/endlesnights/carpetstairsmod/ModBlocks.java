...
{	
	...
	public void registerBlocks(RegistryEvent.Register<Block> event)
	{
		...
		black_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.BLACK_CARPET,DyeColor.BLACK , Block.Properties.from(Blocks.BLACK_CARPET)), "black_carpet_stair");
		blue_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.BLUE_CARPET, DyeColor.BLUE , Block.Properties.from(Blocks.BLUE_CARPET)), "blue_carpet_stair");
		brown_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.BROWN_CARPET, DyeColor.BROWN , Block.Properties.from(Blocks.BROWN_CARPET)), "brown_carpet_stair");
		cyan_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.CYAN_CARPET, DyeColor.CYAN , Block.Properties.from(Blocks.CYAN_CARPET)), "cyan_carpet_stair");
		gray_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.GRAY_CARPET, DyeColor.GRAY , Block.Properties.from(Blocks.GRAY_CARPET)), "gray_carpet_stair");
		green_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.GREEN_CARPET, DyeColor.GREEN , Block.Properties.from(Blocks.GREEN_CARPET)), "green_carpet_stair");
		light_blue_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.LIGHT_BLUE_CARPET, DyeColor.LIGHT_BLUE , Block.Properties.from(Blocks.LIGHT_BLUE_CARPET)), "light_blue_carpet_stair");
		light_gray_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.LIGHT_GRAY_CARPET, DyeColor.LIGHT_GRAY , Block.Properties.from(Blocks.LIGHT_GRAY_CARPET)), "light_gray_carpet_stair");
		lime_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.LIME_CARPET, DyeColor.LIME , Block.Properties.from(Blocks.LIME_CARPET)), "lime_carpet_stair");
		magenta_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.MAGENTA_CARPET, DyeColor.MAGENTA , Block.Properties.from(Blocks.MAGENTA_CARPET)), "magenta_carpet_stair");
		orange_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.ORANGE_CARPET, DyeColor.ORANGE , Block.Properties.from(Blocks.ORANGE_CARPET)), "orange_carpet_stair");
		pink_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.PINK_CARPET, DyeColor.PINK , Block.Properties.from(Blocks.PINK_CARPET)), "pink_carpet_stair");
		purple_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.PURPLE_CARPET, DyeColor.PURPLE , Block.Properties.from(Blocks.PURPLE_CARPET)), "purple_carpet_stair");
		red_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.RED_CARPET, DyeColor.RED , Block.Properties.from(Blocks.RED_CARPET)), "red_carpet_stair");
		white_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.WHITE_CARPET, DyeColor.WHITE , Block.Properties.from(Blocks.WHITE_CARPET)), "white_carpet_stair");
		yellow_carpet_stair = registerBlock(new BlockCarpetStair(Blocks.YELLOW_CARPET, DyeColor.YELLOW , Block.Properties.from(Blocks.YELLOW_CARPET)), "yellow_carpet_stair");

		black_carpet_slab = registerBlock(new CarpetSlab(Blocks.BLACK_CARPET, DyeColor.BLACK, Block.Properties.from(Blocks.BLACK_CARPET).lootFrom(Blocks.BLACK_CARPET)), "black_carpet_slab");
		blue_carpet_slab = registerBlock(new CarpetSlab(Blocks.BLUE_CARPET, DyeColor.BLACK, Block.Properties.from(Blocks.BLACK_CARPET).lootFrom(Blocks.BLACK_CARPET)), "blue_carpet_slab");
		brown_carpet_slab = registerBlock(new CarpetSlab(Blocks.BROWN_CARPET, DyeColor.BROWN , Block.Properties.from(Blocks.BROWN_CARPET).lootFrom(Blocks.BROWN_CARPET)), "brown_carpet_slab");
		cyan_carpet_slab = registerBlock(new CarpetSlab(Blocks.CYAN_CARPET, DyeColor.CYAN , Block.Properties.from(Blocks.CYAN_CARPET).lootFrom(Blocks.CYAN_CARPET)), "cyan_carpet_slab");
		gray_carpet_slab = registerBlock(new CarpetSlab(Blocks.GRAY_CARPET, DyeColor.GRAY , Block.Properties.from(Blocks.GRAY_CARPET).lootFrom(Blocks.GRAY_CARPET)), "gray_carpet_slab");
		green_carpet_slab = registerBlock(new CarpetSlab(Blocks.GREEN_CARPET, DyeColor.GREEN , Block.Properties.from(Blocks.GREEN_CARPET).lootFrom(Blocks.GREEN_CARPET)), "green_carpet_slab");
		light_blue_carpet_slab = registerBlock(new CarpetSlab(Blocks.LIGHT_BLUE_CARPET, DyeColor.LIGHT_BLUE , Block.Properties.from(Blocks.LIGHT_BLUE_CARPET).lootFrom(Blocks.LIGHT_BLUE_CARPET)), "light_blue_carpet_slab");
		light_gray_carpet_slab = registerBlock(new CarpetSlab(Blocks.LIGHT_GRAY_CARPET, DyeColor.LIGHT_GRAY , Block.Properties.from(Blocks.LIGHT_GRAY_CARPET).lootFrom(Blocks.LIGHT_GRAY_CARPET)), "light_gray_carpet_slab");
		lime_carpet_slab = registerBlock(new CarpetSlab(Blocks.LIME_CARPET,DyeColor.LIME , Block.Properties.from(Blocks.LIME_CARPET).lootFrom(Blocks.LIME_CARPET)), "lime_carpet_slab");
		magenta_carpet_slab = registerBlock(new CarpetSlab(Blocks.MAGENTA_CARPET,DyeColor.MAGENTA , Block.Properties.from(Blocks.MAGENTA_CARPET).lootFrom(Blocks.MAGENTA_CARPET)), "magenta_carpet_slab");
		orange_carpet_slab = registerBlock(new CarpetSlab(Blocks.ORANGE_CARPET,DyeColor.ORANGE , Block.Properties.from(Blocks.ORANGE_CARPET).lootFrom(Blocks.ORANGE_CARPET)), "orange_carpet_slab");
		pink_carpet_slab = registerBlock(new CarpetSlab(Blocks.PINK_CARPET,DyeColor.PINK , Block.Properties.from(Blocks.PINK_CARPET).lootFrom(Blocks.PINK_CARPET)), "pink_carpet_slab");
		purple_carpet_slab = registerBlock(new CarpetSlab(Blocks.PURPLE_CARPET,DyeColor.PURPLE , Block.Properties.from(Blocks.PURPLE_CARPET).lootFrom(Blocks.PURPLE_CARPET)), "purple_carpet_slab");
		red_carpet_slab = registerBlock(new CarpetSlab(Blocks.RED_CARPET,DyeColor.RED , Block.Properties.from(Blocks.RED_CARPET).lootFrom(Blocks.RED_CARPET)), "red_carpet_slab");
		white_carpet_slab = registerBlock(new CarpetSlab(Blocks.WHITE_CARPET,DyeColor.WHITE , Block.Properties.from(Blocks.WHITE_CARPET).lootFrom(Blocks.WHITE_CARPET)), "white_carpet_slab");
		yellow_carpet_slab = registerBlock(new CarpetSlab(Blocks.YELLOW_CARPET,DyeColor.YELLOW, Block.Properties.from(Blocks.YELLOW_CARPET).lootFrom(Blocks.YELLOW_CARPET)), "yellow_carpet_slab");
